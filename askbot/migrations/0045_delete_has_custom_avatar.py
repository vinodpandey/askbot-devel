...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.delete_column(auth_db_name, 'has_custom_avatar')

    def backwards(self, orm):
        try:
            db.add_column(auth_db_name, 'has_custom_avatar', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
        except:
            pass
