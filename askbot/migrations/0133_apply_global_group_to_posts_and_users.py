...
def get_superuser(orm):
    ...
    """
    try:
        return orm[AUTH_USER_MODEL].objects.filter(
                        is_superuser=True
                    ).order_by('id')[0]
    except IndexError:
        if orm[AUTH_USER_MODEL].objects.count() > 0:
...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        users = orm[AUTH_USER_MODEL].objects.all()
    ...
    models = {
        ...
        'askbot.groupmembership': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'group_memberships'", 'to': "orm[AUTH_USER_MODEL]"})
        },
        'askbot.groupprofile': {
