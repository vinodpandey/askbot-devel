...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('askbot_thread', 'last_activity_by', self.gf('django.db.models.fields.related.ForeignKey')(null=True, default=None, related_name='unused_last_active_in_threads', to=orm[AUTH_USER_MODEL]), keep_default=False)
    ...
    models = {
        ...
        'askbot.question': {
            ...
            'favorited_by': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'favorite_questions'", 'symmetrical': 'False', 'through': "orm['askbot.FavoriteQuestion']", 'to': "orm[AUTH_USER_MODEL]"}),
