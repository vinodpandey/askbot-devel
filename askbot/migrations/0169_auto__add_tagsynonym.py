...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('askbot_tagsynonym', (
            ...
            ('owned_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tag_synonyms', to=orm[AUTH_USER_MODEL])),
    ...
    models = {
        ...
        'askbot.bulktagsubscription': {
            ...
            'users': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm[AUTH_USER_MODEL]", 'symmetrical': 'False'})
        },
        'askbot.draftanswer': {
            'Meta': {'object_name': 'DraftAnswer'},
            'author': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'draft_answers'", 'to': "orm[AUTH_USER_MODEL]"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'askbot.postrevision': {
            ...
            'approved_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm[AUTH_USER_MODEL]", 'null': 'True', 'blank': 'True'}),
        ...
        'askbot.tag': {
            ...
            'suggested_by': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'suggested_tags'", 'symmetrical': 'False', 'to': "orm[AUTH_USER_MODEL]"}),
        ...
        'askbot.tagsynonym': {
            ...
            'owned_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'tag_synonyms'", 'to': "orm[AUTH_USER_MODEL]"}),
