...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('askbot_post', (
            ...
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(related_name='posts', to=orm[AUTH_USER_MODEL])),
            ...
            ('deleted_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='deleted_posts', null=True, to=orm[AUTH_USER_MODEL])),
            ...
            ('locked_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='locked_posts', null=True, to=orm[AUTH_USER_MODEL])),
            ...
            ('last_edited_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='last_edited_posts', null=True, to=orm[AUTH_USER_MODEL])),
