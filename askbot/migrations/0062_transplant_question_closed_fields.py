...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('askbot_thread', 'closed_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm[AUTH_USER_MODEL], null=True, blank=True), keep_default=False)
